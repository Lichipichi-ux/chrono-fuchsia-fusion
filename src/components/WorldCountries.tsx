...
const newsByCountryAndYear: Record<string, Record<number, { title: string; image: string; content: string; category: string }>> = {
  DE: {
    2020: {
      title: "🇩🇪 IMPULSO DIGITAL: Revolución Tecnológica Post-Pandemia",
    ...
    2025: {
      title: "🇩🇪 DOMINIO DE IA: Drones Autónomos y Fábricas del Futuro",
    ...
    2030: {
      title: "🇩🇪 SOBERANÍA DIGITAL: IA Transforma Salud y Logística",
    ...
    2035: {
      title: "🇩🇪 ERA CUÁNTICA: Ciudades Inteligentes y Energía del Mañana",
    ...
    2040: {
      title: "🇩🇪 SIMBIOSIS TECNOLÓGICA: IA para Clima y Mentes Avanzadas",
    ...
    2045: {
      title: "🇩🇪 ÉTICA GLOBAL: IA Consciente y Educación Universal",
    ...
    2050: {
      title: "🇩🇪 FUTURO CÓSMICO: IA en Marte y Fusión Nuclear",
  ...
  US: {
    2020: {
      title: "🇺🇸 RESPUESTA A LA CRISIS: Batalla por el Dominio Tecnológico",
    ...
    2025: {
      title: "🇺🇸 AUGE BIOTECNOLÓGICO: Energía Verde Revolucionaria",
    ...
    2030: {
      title: "🇺🇸 ERA ESPACIAL: Conquista Comercial del Cosmos",
    ...
    2035: {
      title: "🇺🇸 DOMINIO CUÁNTICO: El Futuro del Trabajo Redefinido",
    ...
    2040: {
      title: "🇺🇸 SOCIEDAD HÍBRIDA: Fusión de lo Digital y lo Físico",
    ...
    2045: {
      title: "🇺🇸 COLONIAS MARCIANAS: El Cenit de la IA Espacial",
    ...
    2050: {
      title: "🇺🇸 ABUNDANCIA CÓSMICA: Energía y Exploración Interplanetaria",
  ...
  JP: {
    2020: {
      title: "🇯🇵 VANGUARDIA ROBÓTICA: Innovación Médica en Japón",
    ...
    2025: {
      title: "🇯🇵 SALUD INTELIGENTE: Auge de la Automatización Doméstica",
    ...
    2030: {
      title: "🇯🇵 MEGACIUDAD SOSTENIBLE: Tokio Redefine el Futuro",
    ...
    2035: {
      title: "🇯🇵 MENTES CONECTADAS: Interfaces Cerebro-Computadora",
    ...
    2040: {
      title: "🇯🇵 SOCIEDAD AUTOMATIZADA: Longevidad y Eficiencia Total",
    ...
    2045: {
      title: "🇯🇵 FUSIÓN VR-FÍSICA: Transformación de la Vida Diaria",
    ...
    2050: {
      title: "🇯🇵 ARMONÍA HUMANO-IA: Exploración Dimensional",
  ...
  FR: {
    2020: {
      title: "🇫🇷 PIONEROS VERDES: Francia Abraza la Sostenibilidad",
    ...
    2025: {
      title: "🇫🇷 PODER NUCLEAR: Energía Inteligente para el Futuro",
    ...
    2030: {
      title: "🇫🇷 SABOR DEL FUTURO: Revolución Gastronómica con IA",
    ...
    2035: {
      title: "🇫🇷 MODA DEL MAÑANA: Renacimiento Sostenible",
    ...
    2040: {
      title: "🇫🇷 ARMONÍA MULTICULTURAL: IA Une Comunidades",
    ...
    2045: {
      title: "🇫🇷 PATRIMONIO VIVO: Fusión de Tradición y Tecnología",
    ...
    2050: {
      title: "🇫🇷 PARAÍSO HUMANO-TECNO: Calidad de Vida Suprema",
  ...
  BR: {
    2020: {
      title: "🇧🇷 AMAZONAS DIGITAL: Biodiversidad en la Era de la IA",
    ...
    2025: {
      title: "🇧🇷 COSECHA INTELIGENTE: Agricultura del Futuro",
      image: "https://stockrc.com/img/cms/Post_AGRICULTURA/29-%20C%C3%B3mo%20obtener%20el%20mapa%20de%20prescripci%C3%B3n%20de%20tierras%20agr%C3%ADcolas.gif",
    ...
    2030: {
      title: "🇧🇷 LIDERAZGO BIOECONÓMICO: Verde y Tecnológico",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2035: {
      title: "🇧🇷 DESARROLLO VERDE: Minería y Ciudades Sostenibles",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
    ...
    2040: {
      title: "🇧🇷 UNIÓN DIGITAL: Conectando un Continente",
    ...
    2045: {
      title: "🇧🇷 ECOSISTEMAS VIVOS: Naturaleza Artificial con IA",
    ...
    2050: {
      title: "🇧🇷 FUSIÓN BIO-TECNO: El Amazonas del Futuro",
      image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833",
  ...
  CN: {
    2020: {
      title: "🇨🇳 RECUPERACIÓN RÁPIDA: China Domina con IA y 5G",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2025: {
      title: "🇨🇳 FÁBRICAS DEL FUTURO: Manufactura Inteligente",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2030: {
      title: "🇨🇳 SOCIEDAD SIN EFECTIVO: Pagos Digitales Absolutos",
      image: "https://cdn.dribbble.com/userupload/27987376/file/original-5c40b987ebab9736fcbf683f7cc2fe68.gif",
    ...
    2035: {
      title: "🇨🇳 SUPERPOTENCIA IA: Vigilancia y Dominio Global",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2040: {
      title: "🇨🇳 CIVILIZACIÓN DIGITAL: Total Conexión Estatal",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2045: {
      title: "🇨🇳 FUSIÓN ANCESTRAL: Filosofía y Tecnología",
      image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833",
    ...
    2050: {
      title: "🇨🇳 CIVILIZACIÓN HÍBRIDA: Dominio Interplanetario",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
  ...
  GB: {
    2020: {
      title: "🇬🇧 BREXIT DIGITAL: Fintech en la Vanguardia",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2025: {
      title: "🇬🇧 CENTRO FINANCIERO: IA Transforma Banca y Educación",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2030: {
      title: "🇬🇧 VIDA ETERNA: Avances Médicos con IA",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2035: {
      title: "🇬🇧 RENACIMIENTO CULTURAL: Arte y VR con IA",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
    ...
    2040: {
      title: "🇬🇧 SOCIEDAD LIBRE: Automatización y Renta Universal",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2045: {
      title: "🇬🇧 MONARQUÍA DIGITAL: Democracia Conectada",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2050: {
      title: "🇬🇧 LABORATORIO GLOBAL: IA y Ciencia sin Límites",
      image: "https://analyticsindiamag.com/wp-content/uploads/2021/12/ezgif.com-gif-maker-14.gif",
  ...
  ES: {
    2020: {
      title: "🇪🇸 TURISMO SOLAR: España Digitaliza su Esencia",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2025: {
      title: "🇪🇸 REINO RENOVABLE: Energía Verde Imparable",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
    ...
    2030: {
      title: "🇪🇸 COSECHA MEDITERRÁNEA: Agricultura con IA",
      image: "https://cdn.imgchest.com/files/45xcvqmlz57.gif",
    ...
    2035: {
      title: "🇪🇸 FUENTE DE LONGEVIDAD: Salud del Futuro",
      image: "https://i.imgur.com/ydfRjjG.gif",
    ...
    2040: {
      title: "🇪🇸 MOSAICO CULTURAL: IA Une Diversidades",
      image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833",
    ...
    2045: {
      title: "🇪🇸 EQUILIBRIO VITAL: Bienestar con IA",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2050: {
      title: "🇪🇸 EDÉN TECNOLÓGICO: Mediterráneo Conectado",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
  ...
  AU: {
    2020: {
      title: "🇦🇺 ESCUDO CLIMÁTICO: IA Contra Desastres Naturales",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2025: {
      title: "🇦🇺 MINERÍA CÓSMICA: Recursos del Espacio con IA",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2030: {
      title: "🇦🇺 GUARDIANES DEL ECOSISTEMA: IA Protege la Naturaleza",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2035: {
      title: "🇦🇺 SUPERVIVENCIA EXTREMA: IA en Desiertos y Más Allá",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
    ...
    2040: {
      title: "🇦🇺 SOCIEDAD INQUEBRANTABLE: Ciudades Resilientes con IA",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2045: {
      title: "🇦🇺 FRONTERAS CÓSMICAS: Investigación Extraterrestre",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2050: {
      title: "🇦🇺 ARMONÍA NATURAL: IA y Ecosistemas Perfectos",
      image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833",
  ...
  CA: {
    2020: {
      title: "🇨🇦 INCLUSIÓN DIGITAL: Canadá Abraza la Diversidad",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
    ...
    2025: {
      title: "🇨🇦 IA CON CONCIENCIA: Ética en la Vanguardia",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
    ...
    2030: {
      title: "🇨🇦 MOSAICO DIGITAL: Multiculturalismo Conectado",
      image: "https://images.unsplash.com/photo-1518770660439-4636190af475",
    ...
    2035: {
      title: "🇨🇦 SALUD PERSONALIZADA: Biotecnología del Futuro",
      image: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7",
    ...
    2040: {
      title: "🇨🇦 DEMOCRACIA CONECTADA: Participación con IA",
      image: "https://images.unsplash.com/photo-1496307653780-42ee777d4833",
    ...
    2045: {
      title: "🇨🇦 RESILIENCIA ÁRTICA: Supervivencia con IA",
      image: "https://www.roboticgizmos.com/wp-content/uploads/2022/04/29/Husky-Robot-Monitoring-Penguins.gif",
    ...
    2050: {
      title: "🇨🇦 POLO CONECTADO: Exploración Polar con IA",
      image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb",
